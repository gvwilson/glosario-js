module.exports = [
  {
    ...
    "en": {
      ...
      "def": "Expresses the fact that 68% of values lie within one [standard deviation](#standard_deviation) of the [mean](#mean), 95% lie within two, and 99.7% lie within three. Conversely, about 0.3% of values lie more than three standard deviations above or below the mean in most cases.\n"
    }
  },
  {
    "slug": "abandonware",
  ...
  },
  {
    ...
    "en": {
      "term": "absolute path",
      "def": "A path that points to the same location in the filesystem regardless of where it's evaluated. An absolute path is the equivalent of latitude and longitude in geography.\n"
    },
    "fr": {
      "term": "chemin d'accès absolu",
      "def": "Un chemin d'accès absolu indique la même position dans le système de fichier quelque soit l'emplacement où il est evalué. Un chemin d'accès absolu est l'équivalent de la latitude et longitude en géographie.\n"
    },
    "es": {
      "term": "ruta absoluta",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The value generated by running code in a test. If this matches the [expected_result](#expected_result), the test [passes](#pass_test); if the two are different, the test [fails](#fail_test).\n"
    }
  },
  {
    "slug": "aggregation",
    ...
    "fr": {
      "term": "agrégation",
      "def": "Synthétise plusieurs valeurs en une seule, example, en sommant plusieurs nombres ou en concaténant un ensemble de caractères.\n"
    }
  },
  {
    ...
    "fr": {
      ...
      "def": "Une fonction qui permet de synthétiser plusieurs valeurs en une seule, example, 'sum' ou 'max'.\n"
    }
  },
  {
    "slug": "agile",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A function that has not been assigned a name.  Anonymous functions are usually quite short, and are usually defined where they are used, e.g., as callbacks.\n"
    }
  },
  {
    "slug": "anti_join",
  ...
  },
  {
    ...
    "en": {
      "term": "argument",
      "def": "A value passed into a function. Some authors use the term as a synonym for [parameter](#parameter) and some do not; it's all very confusing.\n"
    },
    "es": {
      "term": "argumento",
  ...
  },
  {
    ...
    "en": {
      "term": "ASCII",
      "def": "A standard way to represent the characters commonly used in the Western European languages as 7- or 8-bit integers, now superceded by [Unicode](#unicode).\n"
    }
  },
  {
    "slug": "assertion",
  ...
  },
  {
    ...
    "fr": {
      "term": "attribut",
      "def": "Un couple nom-valeur associé à un objet et utilisé pour stocker des Métadonnées concernant ce dernier, example, les dimensions d'un tableau.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A feature that allows the user to finish a word or code quickly through the use of hitting the TAB key to list possible words or code that the user can select from.\n"
    },
    "fr": {
      "term": "auto-complétion",
      "def": "Une fonctionnalité permettant à l'utilisateur de finir rapidement un mot ou du code à travers l'utilisation de la touche TAB qui liste le mot ou le code susceptible d'être choisi par l'utilisateur.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "Software which is able to be used the same way as earlier versions of itself without problems.\n"
    },
    "fr": {
      "term": "compatibilité descendante",
      "def": "Ce dit d'un logiciel qui est capable d'être utilisé de la même manière que ses versions précédentes sans difficulté.\n"
    }
  },
  {
    "slug": "base_r",
  ...
  },
  {
    ...
    "en": {
      "term": "Bayes' Theorem",
      "def": "An equation for calculating the probability that something is true if something related to it is true. If P(X) is the probability that X is true and P(X|Y) is the probability that X is true given Y is true, then P(X|Y) = P(Y|X) * P(X) / P(Y).\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "bias",
      "def": "A statistic is biased if it is systematically or consistency different from the parameter it is supposed to estimate.\n"
    }
  },
  {
    "slug": "big_data",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "An expression with two arguments or parameters, such as `1 + 2`.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "bit",
      "def": "A unit of information representing representing alternatives, yes/no, [true](#true)/[false](#false). In computing a state of either 0 or 1.\n"
    }
  },
  {
    "slug": "boilerplate",
  ...
  },
  {
    ...
    "en": {
      "term": "Boolean",
      "def": "Relating to a variable or data type that can have either a logical value of [true](#true) or a value of [false](#false). Named for George Boole, a 19th Century mathemetician. Binary systems, like all computers are built on this foundation of systems of logical evaluations between states of true and false, 1 or 0.\n"
    }
  },
  {
    "slug": "branch",
  ...
  },
  {
    ...
    "en": {
      "term": "bug report",
      "def": "A collection of files, logs, or related information that describes either an unexpected output of some code or program or an unexpected error or warning. This information is used to help find and fix a bug in the program or code.\n"
    }
  },
  {
    "slug": "bug_tracker",
    "en": {
      "term": "bug tracker",
      "def": "A system that tracks and manages [reported bugs](#bug_report) for a software program, to make it easier to address and fix the bugs.\n"
    }
  },
  {
    "slug": "build_manager",
  ...
  },
  {
    ...
    "en": {
      "term": "camel case",
      "def": "A style of writing code that involves naming variables and objects with no space, underscore (`_`), dot (`.`), or dash (`-`), with each word being capitalized.  Examples include `CalculateSum` and `findPattern`.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "To accept responsibility for handling an error or other unexpected event. R prefers \"handling a condition\" to \"catching an exception\".\n"
    }
  },
  {
    "slug": "causation",
  ...
  },
  {
    ...
    "en": {
      "term": "CC-0",
      "def": "A [Creative Commons license](#cc_license) that imposes no restrictions whatsover, thereby putting a work in the public domain.\n"
    }
  },
  {
    "slug": "cc_by",
    "en": {
      "term": "CC-BY",
      "def": "The [Creative Commons](#cc_license) - Attribution license that requires people to give credit to the author of a work but imposes no other restrictions.\n"
    }
  },
  {
    "slug": "cc_license",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A statistical method for estimating whether two variables in a cross tabulation are correlated.  A chi-square distribution varies from a [normal distribution](#normal_distribution) based on the [degrees of freedom](#degrees_of_freedom) used to calculate it.\n"
    }
  },
  {
    "slug": "class",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "How much of a library or program is executed when tests run. This is normally reported as a percentage of lines of code: for example, if 40 out of 50 lines in a file are run during testing, those tests have 80% code coverage.\n"
    }
  },
  {
    "slug": "code_review",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "An automatically-created list of previously-executed commands.  Most [REPLs](#repl), including the [Unix shell](#shell), record history and allow users to play back recent commands.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "fr": {
      "term": "commentaire",
      "def": "Text écrit dans un script qui n'est pas évalué lors de l'exécution du code. Il est utilisé pour décrire ce qui se passe lorsque le code est évalué. Les commentaires sont en général des notes brèves, qui commencent après un `#` (dans plusieurs langages de programmation)\n"
    }
  },
  {
    "slug": "commit",
    "en": {
      "term": "commit",
      "def": "As a verb, the act of saving a set of changes to a database or version control [repository](#repository). As a noun, the changes saved.\n"
    }
  },
  {
    "slug": "commit_message",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "Originally, a language such as C or Fortran that is translated into machine instructions for execution. Languages such as Java are also compiled before execution, but into [byte code](#byte_code) instead of machine instructions, while languages like Python are compiled to byte code on the fly.\n"
    }
  },
  {
    "slug": "compiler",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The study or application of computational methods for parsing or understanding human languages.  Early approaches were algorithmic; most modern approaches are statistical.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A combination of a document format that allows users to mix prose and code in a single file, and an application that executes that code interactively and in place. The Jupyter Notebook and R Markdown files are both examples of computational notebooks.\n"
    }
  },
  {
    "slug": "condition",
  ...
  },
  {
    ...
    "en": {
      "term": "constructor",
      "def": "A function that creates an object of a particular class.  In the [S3](#s3) object system, constructors are a convention rather than a requirement.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A [prompt](#prompt) that indicates that the command currently being typed is not yet complete and won't be run until it is.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A variable whose value can be any real value, either within a range or unbounded, such as age or distance.\n"
    }
  },
  {
    "slug": "copy_on_modify",
  ...
  },
  {
    ...
    "en": {
      "term": "correlation",
      "def": "How well two variables agree with each other. Correlation is usually measured by calculating a [correlation coefficient](#correlation_coefficient), and does not imply causation.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A measure of how well [correlated](#correlation) two variables are. If the [correlation coefficient](#correlation_coefficient) between X and Y is 1.0, knowing X allows perfect prediction of Y. If the correlation coefficient is 0.0, knowing X tells you nothing about Y, and if it is -1.0, then X predicts Y, but change in X causes an opposite change in Y.\n"
    }
  },
  {
    "slug": "covariance",
  ...
  },
  {
    ...
    "en": {
      ...
      "acronym": "CRAN",
      "def": "A public repository of R packages.\n"
    }
  },
  {
    "slug": "cross_join",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A technique that divides data into [training data](#training_data) and [test data](#test_data).  The training data and correct answers are used to find parameters, and the algorithm's effectiveness is then measured by examining the answers it gives on the test data.\n"
    }
  },
  {
    "slug": "css",
    ...
    "fr": {
      ...
      "def": "Une manière de contrôler l'apparence du rendu HTML. Le CSS est généralement utilisé dans le but de spécifier les polices, les couleurs ainsi que la structure d'une page web.\n"
    }
  },
  {
    "slug": "csv",
    "en": {
      ...
      "acronym": "CSV",
      "def": "A text format for tabular data in which each record is one row and fields are separated by commas. There are many minor variations, particularly around quoting of strings.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "The folder or directory location that the program is operating in. Any action taken by the program occurs relative to this directory.\n"
    }
  },
  {
    "slug": "data_engineer",
  ...
  },
  {
    ...
    "en": {
      "term": "decision tree",
      "def": "A tree whose nodes are questions and whose branches eventually lead to a decision or classification.\n"
    }
  },
  {
    "slug": "deep_learning",
  ...
  },
  {
    ...
    "en": {
      "term": "default value",
      "def": "A value assigned to a function parameter when the caller does not specify a value. Default values are specified as part of the function's definition.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A set of programming practices that assumes mistakes will happen and either report or correct them, such as inserting [assertions](#assertion) to report situations that aren't ever supposed to occur.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A variable whose value can take on only one of a fixed set of values, such as true or false.\n"
    }
  },
  {
    "slug": "distro",
  ...
  },
  {
    ...
    "en": {
      "term": "docstring",
      "def": "Short for \"documentation string\", a string appearing at the start of a module, class, or function in Python that automatically becomes that object's documentation.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "acronym": "DOI",
      "def": "A unique persistent identifier for a book, paper, report, software release, or other digital artefact.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "fr": {
      "term": "vecteur vide",
      "def": "Un vecteur qui ne contient aucun élément. Les vecteurs vides peuvent être de type logique ou caractère, et sont *differents* des vecteurs [null](#null).\n"
    }
  },
  {
    "slug": "environment",
  ...
  },
  {
    ...
    "en": {
      "term": "error handling",
      "def": "What a program does to detect and correct for errors. Examples include printing a message and using a default configuration if the user-specified configuration can't be found.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A sequence of characters used to represent some other character that would otherwise have a special meaning. For example, the escape sequence `\\\"` is used to represent a double-quote character inside a double-quoted string.\n"
    }
  },
  {
    "slug": "evaluation",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The value that a piece of software is suposed to produced when tested in a certain way, or the state in which it is supposed to leave the system.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "fail (a test)",
      "def": "A test fails if the [actual result](#actual_result) does not match the [expected_result](#expected_result).\n"
    }
  },
  {
    "slug": "false",
    ...
    "en": {
      "term": "false",
      "def": "The logical ([Boolean](#boolean)) state opposite of \"[true](#true)\". Used in logic and programming to represent [binary](#binary) state of something.\n"
    }
  },
  {
    "slug": "falsy",
  ...
  },
  {
    ...
    "en": {
      "term": "feature branch",
      "def": "A branch within a Git repository containing commits dedicated to a specific feature, e.g., a bug fix or a new function. This branch can be merged into another branch.\n"
    }
  },
  {
    "slug": "feature_data",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The last part of a filename, usually following the '.' symbol. Filename extensions are commonly used to indicate the type of content in the file, though there is usually no guarantee that this is correct.\n"
    }
  },
  {
    "slug": "filename_stem",
    "en": {
      "term": "filename stem",
      "def": "The part of the filename that doesn't include the [stem](#filename_stem). For example, the stem of `glossary.yml` is `glossary`.\n"
    }
  },
  {
    "slug": "filesystem",
    "en": {
      "term": "filesystem",
      "def": "Controls how files are stored and retrieved on disk by an operating system. Also used to refer to the disk that is used to store the files or the type of the filesystem.\n"
    }
  },
  {
    "slug": "filter",
    "en": {
      "term": "filter",
      "def": "To choose a set of [records](#record) (i.e., rows of a table) based on the values they contain.\n"
    },
    "fr": {
      "term": "filtrer",
      "def": "Le fait de sélectionner un ensemble d'[observations](#record) (example, certaines lignes d'une table) en se basant sur leurs valeurs.\n"
    }
  },
  {
    "slug": "fixture",
    "en": {
      "term": "fixture",
      "def": "The thing on which a test is run, such as the parameters to the function being tested or the file being processed.\n"
    }
  },
  {
    "slug": "folder",
  ...
  },
  {
    ...
    "en": {
      "term": "fork",
      "def": "A copy of one person's Git repository that lives in another person's GitHub account. Changes to the content of a fork can be submitted to the [upstream repository](#upstream_repository) via a [pull request](#pull_request).\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A unique 160-bit identifier for a [commit](#commit) in a Git [repository](#repository), usually written as a 20-character [hexadecimal](#hexadecimal) character string.\n"
    }
  },
  {
    "slug": "full_join",
    ...
    "en": {
      "term": "full join",
      "def": "A [join](#join) that returns all rows and all columns from two tables A and B. Where the [keys](#key) of A and B match, values are combined; where they do not, missing values from either table are filled with [null](#null), [NA](#na), or some other [missing value](#missing_value).\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "An unambiguous name of the form `package::thing`.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A style of programming in which data is transformed through successive application of functions, rather than by using control structures such as loops.\n"
    }
  },
  {
    ...
    "fr": {
      ...
      "def": "Une collection de fonctions ayant un objectif similaire, chacune opérant sur une classe de données différente.\n"
    }
  },
  {
    "slug": "geometric_mean",
  ...
  },
  {
    ...
    "en": {
      "term": "Git",
      "def": "A version control tool to record and manage changes to a project.\n"
    },
    "fr": {
      "term": "Git",
      "def": "Un outil de gestion des versions qui permet d'enregistrer et de piloter les modifications effectuées au niveau d'un projet.\n"
    },
    "pt": {
      "term": "Git",
      "def": "Uma ferramenta de controle de versão para registrar e gerenciar mudanças em um projeto.\n"
    }
  },
  {
    "slug": "git_branch",
    ...
    "en": {
      "term": "Git branch",
      "def": "A snapshot of a version of a Git repository. Multiple branches can capture multiple versions of the same repository.\n"
    },
    "fr": {
      "term": "Git branch",
      "def": "Une photographie d'une version d'un dépôt Git. Plusieurs branches peuvent capturer plusieurs versions au niveau d'un même dépôt.\n"
    }
  },
  {
    "slug": "git_clone",
    "en": {
      "term": "Git clone",
      "def": "Copies (and usually downloads) a Git [remote repository](#remote_repository) onto the local computer.\n"
    },
    "fr": {
      "term": "Git clone",
      "def": "Permet de copier (et générallement de télécharger) un [dépôt éloigné](#remote_repository) Git au niveau de l'ordinateur local.\n"
    }
  },
  {
    "slug": "git_conflict",
    "en": {
      "term": "Git conflict",
      "def": "A situation in which incompatible or overlapping changes have been made on different branches that are now being [merged](#git_merge).\n"
    }
  },
  {
    "slug": "git_fork",
    ...
    "en": {
      "term": "Git fork",
      "def": "To make a new copy of a Git [repository](#repository) on a server, or the copy that is made.\n"
    }
  },
  {
    "slug": "git_merge",
    "en": {
      "term": "Git merge",
      "def": "Merging branches in Git incorporates development histories of two branches in one. If changes are made to similar parts of the branches on both branches a commit will occur and this must be resolved before the merge will be completed.\n"
    }
  },
  {
    "slug": "git_pull",
    ...
    "fr": {
      "term": "Git pull",
      "def": "Télécharge et synchronise des modifications entre le [dépôt éloigné](#remote_repository) et le [dépôt](#repository) local.\n"
    }
  },
  {
    "slug": "git_push",
    ...
    "fr": {
      "term": "Git push",
      "def": "Charge et synchronise des modifications entre le [dépôt](#repository) local et le [dépôt éloigné](#remote_repository).\n"
    }
  },
  {
    "slug": "git_remote",
  ...
  },
  {
    ...
    "fr": {
      "term": "Github",
      "def": "Une platefome dans le Cloud, construite autour de [Git](#git) qui permet de sauvegarder en ligne les versions d'un projet et de collaborer avec d'autres utilisateurs Git.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "The [environment](#environment) that holds top-level definitions in R, e.g., those written directly in the interpreter.\n"
    },
    "fr": {
      "term": "environnement global",
      "def": "L'[environnement](#environment) qui contient des définitions de premier niveau dans R, example, celles écrites directement dans l'intérpreteur.\n"
    }
  },
  {
    ...
    "fr": {
      ...
      "def": "Le fait d'installer un package dans un emplacement où il peut être accessible par tous les utilisateurs ainsi que tous les projets.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A variable defined outside any particular function, which is therefore visible to all functions.\n"
    },
    "es": {
    ...
    "fr": {
      ...
      "def": "Une variable définie en dehors d'une fonction donnée, qui est par conséquent visible pour toutes les fonctions.\n"
    }
  },
  {
    "slug": "gpl",
    "en": {
      ...
      "acronym": "GPL",
      "def": "A license that allows people to re-use software as long as they distribute the source of their changes.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "An optimization algorithm that repeatedly calculates the gradient at the current point takes a small step in that direction, and then recalculates the gradient.\n"
    }
  },
  {
    "slug": "group",
    "en": {
      "term": "group",
      "def": "To divide data into subsets according to some criteria while leaving records in a single structure.\n"
    }
  },
  {
    "slug": "gui",
  ...
  },
  {
    ...
    "en": {
      "term": "hash table",
      "def": "A data structure that calculates a pseudo-random key for each value and stores the value in that location. Hash tables enable fast lookup for arbitrary data at the cost of extra memory.\n"
    }
  },
  {
    "slug": "header_row",
    ...
    "en": {
      "term": "header row",
      "def": "If present, the first row of a CSV file that defines column names (but tragically, not their data types or units).\n"
    }
  },
  {
    "slug": "heterogeneous",
    ...
    "en": {
      "term": "heterogeneous",
      "def": "Having mixed type. For example, an list can contain a mix of numbers, character strings, and values of other types.\n"
    }
  },
  {
    "slug": "hexadecimal",
    "en": {
      "term": "hexadecimal",
      "def": "A base-16 number system. Hexadecimal values are usually written using the digits 0-9 and the characters A-F in either upper or lower case. Hexadecimal is often used to represent [binary](#binary) values, since two hexadecimal digits exactly fit one byte.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A function that operates on other functions. For example, the higher-order function `map` executes a given function once on each value in an [list](#list). Higher-order functions are heavily used in [functional programming](#functional_programming).\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "hitchhiker",
      "def": "Someone who is part of a project but doesn't actually do any work on it.\n"
    }
  },
  {
    "slug": "home_directory",
  ...
  },
  {
    ...
    "en": {
      "term": "homogeneous",
      "def": "Having a single type. For example, a [vector](#vector) must be homogeneous: its values must all be numeric, logical, etc.\n"
    }
  },
  {
    "slug": "ide",
    ...
    "en": {
      ...
      "acronym": "IDE",
      "def": "An application that helps programmers develop software. IDEs typically have a built-in editor, a console to execute code immediately, and browsers for exploring data structures in memory and files on disk.\n"
    },
    "es": {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The false belief that one's successes are a result of accident or fraud rather than ability.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "inner join",
      "def": "A [join](#join) that returns combinations of rows from two tables A and B whose [keys](#key) match.\n"
    }
  },
  {
    "slug": "instance",
  ...
  },
  {
    ...
    "en": {
      "term": "interpeter",
      "def": "A program that runs other programs interactively.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "interpreter",
      "def": "A program whose job it is to run programs written in a high-level [interpreted language](#interpreted_language).\n"
    }
  },
  {
    "slug": "invariant",
    "en": {
      "term": "invariant",
      "def": "Something that is guaranteed to be true at some point in a program. Invariants are often expressed using [assertions](#assertion).\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "label (an issue)",
      "def": "A short textual tag associated with an [issue](#issue) to categorize it. Common labels include `bug` and `feature request`.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "Is similar to a [bug tracking system](#bug_tracker) in that it tracks \"issues\" made to a [repository](#repository), usually in the form of [feature requests](#feature_request), [bug reports](#bug_report), or some other todo item.\n"
    }
  },
  {
    "slug": "join",
  ...
  },
  {
    ...
    "en": {
      ...
      "acronym": "JSON",
      "def": "A way to represent data by combining basic values like numbers and character strings in lists and name/value structures. The acronym stands for \"JavaScript Object Notation\"; unlike better-defined standards like [XML](#xml), it is unencumbered by a syntax for comments or ways to define a [schema](#schema).\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A [classification](#classification) algorithm that classifies data points based on their similarity to nearby neighbors.\n"
    }
  },
  {
    "slug": "kebab_case",
  ...
  },
  {
    ...
    "en": {
      "term": "key",
      "def": "A [field](#field) or combination of fields whose value(s) uniquely identify a [record](#record) within a [table](#table) or dataset. Keys are often used to select specific record and in [joins](#join).\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "Extra arguments given to a function as key-value pairs.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "LaTeX",
      "def": "The FORTRAN of scientific publishing.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "Delaying evaluation of an expression until the value is actually needed (or at least until after the point where it is first encountered).\n"
    }
  },
  {
    "slug": "left_join",
    ...
    "en": {
      "term": "left join",
      "def": "A [join](#join) that combines data from two tables A and B.  Where keys in table A match keys in table B, [fields](#field) are concatenated.  Where a key in table A does *not* match a key in table B, columns from table B are filled with [null](#null), [NA](#na), or some other [missing value](#missing_value).\n"
    }
  },
  {
    "slug": "library",
  ...
  },
  {
    ...
    "en": {
      "term": "lift",
      "def": "How well a model predicts or classifies things, measured as the ratio of the response in the segment identified to the response in the population as a whole.  A lift of 1 means the model does no better than chance; higher lift means the model is doing better.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A method for finding the best straight-line fit between two datasets, typically by minimizing the squares of the distances between the points and a line.\n"
    }
  },
  {
    "slug": "linter",
  ...
  },
  {
    ...
    "en": {
      "term": "list",
      "def": "A [vector](#vector) that can contain values of many different types.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "In Python, an expression that creates a new list in place.  For example, `[2*x for x in values]` creates a new list whose items are the doubles of those in `values`.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "Placing a package inside a particular project so that it is only accessible within that project.\n"
    }
  },
  {
    "slug": "local_variable",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A software library that managing internal reporting for programs.\n"
    }
  },
  {
    "slug": "logging_level",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "To index a vector or other structure with a vector of Booleans, keeping only the values that correspond to true values.  Also referred to as [masking](#masking).\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "Markdown",
      "def": "A markup language with a simple syntax intended as a replacement for HTML. Markdown is often used for README files, and is the basis for [R markdown](r_markdown).\n"
    }
  },
  {
    "slug": "markov_chain",
    ...
    "en": {
      "term": "Markov Chain",
      "def": "Any [model](#model) describing a series of unfortunate events in which the probability of each event depends only on the current state, not on the path taken to reach that state.\n"
    }
  },
  {
    "slug": "marthas_rules",
  ...
  },
  {
    ...
    "en": {
      "term": "master branch",
      "def": "A dedicated, permanent, central branch which should contain a \"ready product\". As a new feature is developed on a separate branch to avoid breaking the main code, it can be merged into the master branch.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "To choose the parameters for a [probability distribution](#probability_distribution) in order to maximize the likelihood of obtaining observed data.\n"
    }
  },
  {
    "slug": "mean",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The average of the squares of all the errors of all predicted values compared with actual values.  Squaring makes larger errors count for more, making this a more popular measure than [mean absolute error](#mean_absolute_error).\n"
    }
  },
  {
    "slug": "median",
    ...
    "en": {
      "term": "median",
      "def": "A value separating the upper and lower halves of a sorted dataset. The median often gives a better idea of what is typical of the dataset than the [mean](#mean), which can be influenced by a small number of extreme outliers.\n"
    }
  },
  {
    "slug": "merge_git",
  ...
  },
  {
    ...
    "en": {
      "term": "missing value",
      "def": "A special value such as [null](#null) or [NA](#na) used to indicate the absence of data. Missing values can signal that data was not collected or that the data didn't exist in the first place (e.g., the middle name of someone who doesn't have one).\n"
    }
  },
  {
    "slug": "mit_license",
    "en": {
      "term": "MIT License",
      "def": "A license that allows people to re-use software with no restrictions.\n"
    }
  },
  {
    "slug": "mode",
    ...
    "en": {
      "term": "mode",
      "def": "The value that occurs most frequently in a dataset.\n"
    }
  },
  {
    "slug": "model",
  ...
  },
  {
    ...
    "en": {
      "term": "moving average",
      "def": "The [mean](#mean) of each set of several several consecutive values from [time series](#time_series) data.\n"
    }
  },
  {
    "slug": "mutation",
  ...
  },
  {
    ...
    "en": {
      "term": "name collision",
      "def": "The ambiguity that arises when two or more things in a program that have the same name are active at the same time.\n"
    }
  },
  {
    "slug": "named_argument",
    ...
    "en": {
      "term": "named argument",
      "def": "A function parameter that is given a value by explicitly naming it in a function call.\n"
    }
  },
  {
    "slug": "namespace",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "To specify the elements of a vector or other data structure that aren't desired by negating their indices.\n"
    }
  },
  {
    "slug": "neural_network",
  ...
  },
  {
    ...
    "en": {
      "term": "NoSQL database",
      "def": "Any database that doesn't use the relational model.  The awkward name comes from the fact that such databases don't use [SQL](#sql) as a query language.\n"
    }
  },
  {
    "slug": "null",
    "en": {
      "term": "null",
      "def": "A special value used to represent a missing object.  Null is not the same as NA, and neither is the same as an [empty vector](#empty_vector).\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "acronym": "OOP",
      "def": "A style of programming in which functions and data are bound together in objects that only interact with each other through well-defined interfaces.\n"
    }
  },
  {
    "slug": "open_license",
    "en": {
      "term": "open license",
      "def": "A license that permits general re-use, such as the [MIT License](#mit_license) or [GPL](#gpl) for software and [CC-BY](#cc_by) or [CC-0](#cc_0) for data, prose, or other creative outputs.\n"
    }
  },
  {
    "slug": "open_science",
  ...
  },
  {
    ...
    "en": {
      "term": "orthogonality",
      "def": "The ability to use various features of software in any combination. Orthogonal systems tend to be easier to understand, since features can be combined without worrying about unexpected interactions.\n"
    }
  },
  {
    "slug": "outlier",
  ...
  },
  {
    ...
    "en": {
      "term": "p value",
      "def": "The probability of obtaining a result at least as strong as the one observed if the [null_hypothesis](#null_hypothesis) is true (i.e., if variation is purely due to chance). The lower the p-value, the more likely it is that something other than chance is having an effect.\n"
    }
  },
  {
    "slug": "package",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A program that does its best to keep track of the bits and bobs of software installed on a computer and their dependencies on one another.\n"
    }
  },
  {
    "slug": "pager",
  ...
  },
  {
    ...
    "en": {
      "term": "parameter",
      "def": "A variable whose value is passed into a function when the function is called. Some writers distinguish parameters (the variables) from [arguments](#argument) (the values passed in), but others use the terms in the opposite sense. It's all very confusing.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "The directory that contains another directory of interest.  Going from a directory to its parent, then its parent, and so on eventually leads to the [root directory](#root_directory) of the [filesystem](#filesystem).\n"
    }
  },
  {
    "slug": "parse",
  ...
  },
  {
    ...
    "en": {
      "term": "pass (a test)",
      "def": "A test passes if the [actual result](#actual_result) matches the [expected_result](#expected_result).\n"
    }
  },
  {
    "slug": "patch",
    "en": {
      "term": "patch",
      "def": "A single file containin a set of changes to a set of files, separated by markers that indicate where each individual change should be applied.\n"
    }
  },
  {
    "slug": "path",
    ...
    "en": {
      ...
      "def": "A string that specifies a location in a [filesystem](#filesystem). In Unix, the directories in a path are joined using `/`.\n"
    }
  },
  {
    "slug": "pattern_rule",
  ...
  },
  {
    ...
    "en": {
      "term": "Peanuts",
      "def": "An American comic strip by Charles M. Schulz which has inspired the names of R versions.\n"
    }
  },
  {
    "slug": "perceptron",
    "en": {
      "term": "perceptron",
      "def": "The simplest kind of [neural network])(#neural_network), which approximates a single neuron with N binary inputs by computing a weighted sum of its inputs and firing if that value is zero or greater.\n"
    }
  },
  {
    "slug": "permalink",
  ...
  },
  {
    ...
    "en": {
      "term": "phony target",
      "def": "A [build target](#build_target) that doesn't correspond to an actual file. Phony targets are often used to store commonly-used commands in a [Makefile](#makefile).\n"
    }
  },
  {
    "slug": "pipe_operator",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "An argument to a function that gets its value according to its place in the function's definition, as opposed to a [named argument](#named_argument) that is explicitly matched by name.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A style of programming in which functions operate on data that is passed into them. The term is used in contrast to [object-oriented programming](#oop).\n"
    }
  },
  {
    "slug": "process",
    "en": {
      "term": "process",
      "def": "An [operating system](#operating_system)'s representation of a running program. A process typically has some memory, the identify of the user who is running it, and a set of connections to open files.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "prompt",
      "def": "The text printed by a [REPL](#repl) or [shell](#shell) that indicates it is ready to accept another command. The default prompt in the Unix shell is usually `$`, while in Python it is `>>>`.\n"
    }
  },
  {
    "slug": "provenance",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A value generated in a repeatable way that resemble the true randomness of the universe well enough to fool merely mortal observers.\n"
    }
  },
  {
    "slug": "pull_indexing",
    ...
    "en": {
      "term": "pull indexing",
      "def": "Vectorized indexing in which the value at location `i` in the index vector specifies which element of the source vector is being pulled into that location in the result vector, i.e., `result[i] = source[index[i]]`.\n"
    }
  },
  {
    "slug": "pull_request",
    ...
    "en": {
      "term": "pull request",
      "def": "The request to merge a new feature or correction created on a user's fork of a [Git](#git) repository into the [upstream repository](#upstream_repository). The developer will be notified of the change, review it, make or suggest changes, and potentially merge it.\n"
    }
  },
  {
    "slug": "push_indexing",
    ...
    "en": {
      "term": "push indexing",
      "def": "Vectorized indexing in which the value at location `i` in the index vector specifies an element of the result vector that gets the corresponding element of the source vector, i.e., `result[index[i]] = source[i]`.  Push indexing can easily produce gaps and collisions.\n"
    }
  },
  {
    "slug": "quantile",
  ...
  },
  {
    ...
    "en": {
      "term": "R Foundation",
      "def": "A non-profit founded by the R development core team providing support for R. It is a member of the [R Consortium](#r_consortium).\n"
    }
  },
  {
    "slug": "r_hub",
    "en": {
      "term": "R Hub",
      "def": "A free platform available to check a `R` package on several different platforms in preparation for the CRAN submission process.\n"
    }
  },
  {
    "slug": "r_markdown",
    "en": {
      "term": "R Markdown",
      "def": "A dialect of [Markdown](#markdown) that allows authors to mix prose and code (usually written in R) in a single document.  Cf. [literate programming](#literate_programming).\n"
    },
    "es": {
      "term": "R Markdown",
      "def": "Un dialecto de [Markdown](#markdown) que permite a sus autores mezclar prosa y código (usualmente escrito en R) en un mismo documento. Cf. [literate programming](#literate_programming).\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "To signal that something unexpected or unusual has happened in a program by creating an [exception](#exception) and handing it to the error-handling system, which then tries to find a point in the program that will [catch](#catch_exception) it.\n"
    }
  },
  {
    "slug": "random_forests",
    "en": {
      "term": "random forests",
      "def": "A [classification](#classification) algorithm An algorithm used for regression or classification that uses [decision trees](#decision_tree). Each tree votes for a classification, and the algorithm chooses the classification having the most votes over all the trees in the forest.\n"
    }
  },
  {
    "slug": "raster_image",
  ...
  },
  {
    ...
    "en": {
      "term": "recycle",
      "def": "To re-use values from a shorter vector in order to generate a sequence of the same length as a longer one.\n"
    },
    "es": {
      "term": "reciclar",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "Testing software to ensure that things which used to work haven't been broken.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A pattern for matching text, written as text itself. Regular expressions are sometimes called \"regexp\", \"regex\", or \"RE\", and are as powerful as they are cryptic.\n"
    },
    "es": {
      "term": "expresión regular",
      "def": "Un patrón para buscar coincidencias en texto, que están a su vez escritas como texto. Las expresiones regulares a veces son llamadas \"regexp\", \"regex\" o \"RE\", y son tan poderosas como crípticas.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "Any [machine learning](#machine_learning) algorithm which is not given specific goals to meeting, but instead is given feedback on whether or not it is making progress.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "A database that organizes information into tables, each of which has a fixed set of named fields (shown as columns) and a variable number of records (shown as rows).\n"
    },
    "es": {
  ...
  },
  {
    ...
    "en": {
      "term": "relative error",
      "def": "The absolute value of the difference between the actual and correct value divided by the desired value. For example, if the actual value is 9 and the correct value is 10, the relative error is 0.1. Relative error is usually more useful than [absolute error](#absolute_error).\n"
    }
  },
  {
    "slug": "relative_path",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A [repository](#repository) located on another computer. Tools such as Git are designed to synchronize changes between local and remote repositories in order to share work.\n"
    }
  },
  {
    "slug": "repl",
  ...
  },
  {
    ...
    "pt": {
      "term": "repositório",
      "def": "Um local onde um [sistema de controle de versão](#version_control_system) armazena os arquivos que compõem um projeto e os metadados que descrevem sua história.\n"
    }
  },
  {
    "slug": "reprex",
    "en": {
      "term": "reprex",
      "def": "A reproducible example. When asking questions about coding problems online or filing issues on GitHub, you should always include a reprex so others can reproduce your problem and help. The [reprex](https://github.com/tidyverse/reprex) package can help!\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The practice of escribing and documenting research results in such a way that another researcher or person can re-run the analysis code on the exact data to obtain the same result.\n"
    },
    "pt": {
      "term": "Pesquisa Reprodutível",
      "def": "A prática de escrever e documentar resultados de pesquisa de forma que outras pessoas pesquisadoras possam executar novamente o código de análise com os mesmos dados para obter os mesmos resultados.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "acronym": "reST",
      "def": "A plaintext markup format used primarily in Python documentation.\n"
    }
  },
  {
    "slug": "revision",
  ...
  },
  {
    ...
    "en": {
      "term": "right join",
      "def": "A [join](#join) that combines data from two tables A and B.  Where keys in table A match keys in table B, [fields](#field) are concatenated.  Where a key in table A does *not* match a key in table B, columns from table A are filled with [null](#null), [NA](#na), or some other [missing value](#missing_value).\n"
    }
  },
  {
    "slug": "root_directory",
    "en": {
      "term": "root directory",
      "def": "The directory that contains everything else, directly or indirectly. The root directory is written `/` (a bare forward slash).\n"
    }
  },
  {
    ...
    "en": {
      ...
      "acronym": "RMSE",
      "def": "The square root of the [mean squared error](#mean_squared_error).  Like the [standard deviation](#standard_deviation), it is in the same units as the original data.\n"
    }
  },
  {
    "slug": "rotating_file",
  ...
  },
  {
    ...
    "en": {
      "term": "S3",
      "def": "A framework for object-oriented programming in R.\n"
    }
  },
  {
    "slug": "s4",
  ...
  },
  {
    ...
    "en": {
      "term": "S",
      "def": "A language originally developed in Bell Labs for data analysis, statistical modeling, and graphics. R is a dialect of S.\n"
    },
    "es": {
      "term": "S",
      "def": "Un lenguaje para análisis de datos, modelado estadístico y gráficos desarrollado originalmente en los Laboratorios Bell. R es un dialecto de S.\n"
    }
  },
  {
    "slug": "scalar",
    "en": {
      "term": "scalar",
      "def": "A single value of a particular type, such as 1 or \"a\".  Scalars don't really exist in R; values that appear to be scalars are actually vectors of unit length.\n"
    },
    "es": {
      "term": "escalar",
      "def": "Un único valor de un tipo particular, como 1 o \"a\". Los escalares realmente no existen en R; los valores que parecen ser escalares son en realidad vectores de largo uno.\n"
    }
  },
  {
    "slug": "schema",
  ...
  },
  {
    ...
    "en": {
      "term": "scope",
      "def": "The portion of a program within which a definition can be seen and used. Cf. [closure](#closure), [global variable](#global_variable), and [local variable](#local_variable).\n"
    }
  },
  {
    "slug": "script",
    "en": {
      "term": "script",
      "def": "Originally, a program written in a language too usable for \"real\" programmers to take seriously; the term is now synonymous with program.\n"
    }
  },
  {
    "slug": "search_path",
    "en": {
      "term": "search path",
      "def": "The list of directories that a program searches to find something. For example, the Unix [shell](#shell) uses the search path stored in the `PATH` variable when trying to find a program given its name.\n"
    }
  },
  {
    "slug": "seed",
  ...
  },
  {
    ...
    "en": {
      "term": "select",
      "def": "To choose entire columns from a table by name or location.\n"
    }
  },
  {
    "slug": "self_join",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A standard for identifying software releases. In the version identifier `major.minor.patch`, `major` changes when a new version of software is incompatible with old versions, `minor` changes when new features are added to an existing version, and `patch` changes when small bugs are fixed.\n"
    }
  },
  {
    "slug": "sense_vote",
  ...
  },
  {
    ...
    "en": {
      "term": "shebang",
      "def": "In Unix, a character sequence such as `#!python` in the first line of a runnable file that tells the [shell](#shell) what program to use to run that file.\n"
    }
  },
  {
    "slug": "shell",
    "en": {
      "term": "shell",
      "def": "A [command-line interface](#cli) that allows a user to interact with the operating system, such as Bash (for Unix) or PowerShell (for Windows).\n"
    }
  },
  {
    "slug": "shell_script",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A logical test that only evaluates as many arguments as it needs to. For example, if `A` is false, then most languages never evaluate `B` in the expression `A and B`.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "The first few characters of a [full identifier](#full_identifier_git). Short identifiers are easy for people to type and say aloud, and are usually unique within a repository's recent history.\n"
    }
  },
  {
    "slug": "short_option",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A way of indicating that something has gone wrong in a program, or that some other unexpected event has occurred.  R prefers \"signalling a condition\" to \"raising an exception\".\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "An index enclosed in `[...]`, used to select a structure from another structure.\n"
    }
  },
  {
    "slug": "singleton",
  ...
  },
  {
    ...
    "en": {
      "term": "SQL",
      "def": "The language used for writing queries for a [relational database](#relational_database). The term was originally an acronym for Structured Query Language.\n"
    },
    "es": {
      "term": "SQL",
      "def": "Lenguaje utilizado para escribir consultas para una [base de datos relacional](#relational_database). El término era originalmente un acrónimo del inglés Structured Query Language (Lenguage Estructurado de Consulta).\n"
    }
  },
  {
    "slug": "ssh",
    "en": {
      "term": "Secure Shell",
      "acronym": "SSH",
      "def": "A program that allows secure access to remote computers.\n"
    }
  },
  {
    "slug": "ssh_key",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A [normal distribution](#normal_distribution) with a [mean](#mean) of 0 and a [standard deviation](#standard_deviation) of 1. Values from normal distributions with other parameters can easily be rescaled to be on a standard normal distribution.\n"
    }
  },
  {
    "slug": "stderr",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "Selecting values by dividing the overall population into homogeneous groups and then taking a random sample from each group.\n"
    }
  },
  {
    "slug": "string",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "The process of inserting text corresponding to specified values into a string, usually to make output human-readable.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "subcommand",
      "def": "A command that is part of a larger family of commands. For example, `git commit` is a subcommand of Git.\n"
    }
  },
  {
    "slug": "subdirectory",
  ...
  },
  {
    ...
    "en": {
      ...
      "def": "A [machine learning](#machine_learning) algorithm in which a system is taught to classify values given [training data](#training_data) containing previously-classified values.\n"
    }
  },
  {
    "slug": "svm",
    "en": {
      ...
      "acronym": "SVM",
      "def": "A [supervised learning](#supervised_learning) algorithm that seeks to divide points in a dataset so that the empty space between the two sets is as wide as possible.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "table",
      "def": "A set of records in a [relational database](#relational_database) or observations in a [data frame](#data_frame).  Tables are usually displayed as rows (each of which represents one [record](#record) or [observation](#observation)) and columns (each of which represents a [field](#field) or [variable](#variable_data)).\n"
    }
  },
  {
    "slug": "tag",
    "en": {
      ...
      "def": "A readable label attached to a specific [commit](#commit) so that it can easily be referred to later.\n"
    }
  },
  {
    "slug": "tdd",
    "en": {
      ...
      "acronym": "TDD",
      "def": "A programming practice in which tests are written before a new feature is added or a bug is fixed in order to clarify the goal.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "tibble",
      "def": "A modern replacement for R's data frame, which stores tabular data in columns and rows, defined and used in the [tidyverse](#tidyverse).\n"
    },
    "fr": {
      "term": "tibble",
      "def": "Une alternative moderne du \"data frame\" en R permettant de matérialiser des données tabulaires en colonnes et en lignes, le \"tibble\" a été défini et est utilisé dans le [tidyverse](#tidyverse).\n"
    },
    "es": {
      "term": "tibble",
      "def": "Un remplazo moderno para los data frames de R que guarda datos tabulares en columnas y filas, definido y usado en el [tidyverse](#tidyverse).\n"
    }
  },
  {
    "slug": "ticket",
  ...
  },
  {
    ...
    "en": {
      "term": "Tidymodels",
      "def": "A collection of R packages for modeling and statistical analysis designed with a [shared philosophy](https://tidymodels.github.io/model-implementation-principles/index.html).\n"
    },
    "fr": {
      "term": "Tidymodels",
      "def": "Une collection de packages R pour la modélisation et l'analyse statistique élaborés en prenant en considération une [philosophie partagée](https://tidymodels.github.io/model-implementation-principles/index.html)\n"
    }
  },
  {
    "slug": "tidyverse",
    "en": {
      "term": "Tidyverse",
      "def": "A collection of R packages for operating on tabular data in consistent ways.\n"
    },
    "fr": {
      "term": "Tidyverse",
      "def": "Une collection de packages R permettant le traitement des données tabulaire d'une manière cohérente.\n"
    },
    "es": {
      "term": "Tidyverse",
      "def": "Una colección de paquetes de R para operar de maneras consistentes con datos tabulares.\n"
    },
    "pt": {
      "term": "Tidyverse",
      "def": "Uma coleção de pacotes de R para trabalhar de forma consistente com dados tabulares.\n"
    }
  },
  {
    "slug": "time_series",
  ...
  },
  {
    ...
    "en": {
      "term": "true",
      "def": "The logical ([Boolean](#boolean)) state opposite of \"[false](#false)\". Used in logic and programming to represent [binary](#binary) state of something.\n"
    }
  },
  {
    "slug": "truthy",
    ...
    "en": {
      "term": "truthy",
      "def": "Evaluating to true in a [Boolean](#boolean) context.\n"
    }
  },
  {
    "slug": "tuple",
    "en": {
      "term": "tuple",
      "def": "A value that has multiple parts, such as the three color components of a red-green-blue color specification.\n"
    }
  },
  {
    "slug": "type_coercion",
  ...
  },
  {
    ...
    "en": {
      "term": "unit test",
      "def": "A test that exercises one function or feature of a piece of software.\n"
    }
  },
  {
  ...
  },
  {
    ...
    "en": {
      "term": "UTF-8",
      "def": "A way to store the numeric codes representing Unicode characters in memory that is [backward-compatible](#backward_compatible) with the older [ASCII](#ascii) standard.\n"
    }
  },
  {
    ...
    "en": {
      ...
      "def": "In a function, the ability to take any number of arguments.  R uses `...` to capture the \"extra\" arguments.\n"
    },
    "fr": {
      "term": "arguments d'une variable",
      "def": "La possibilité d'intégrer n'importe quel nombre d'arguments dans une fonction. R utilise `...` afin de capturer les arguments \"additionnels\".\n"
    }
  },
  {
    "slug": "variable_data",
  ...
  },
  {
    ...
    "fr": {
      ...
      "def": "Un nom associé à des données au niveau d'un programme. La valeur d'une variable peut être modifiée après l'avoir définie.\n"
    }
  },
  {
    "slug": "variance",
  ...
  },
  {
    ...
    "en": {
      "term": "vector",
      "def": "A sequence of values, usually of [homogeneous](#homogeneous) type.  Vectors are the fundamental data structure in R; a [scalar](#scalar) is just a vector with exactly one element.\n"
    },
    "es": {
      "term": "vector",
      "def": "Una secuencia de valores, normalmente de tipo [homogéneo](#homogéneo). Los vectores son la estructura de datos fundamental en R; un [escalar](#escalar) es solo un vector con exactamente un elemento.\n"
    }
  },
  {
    "slug": "vectorize",
  ...
  },
  {
    ...
    "fr": {
      ...
      "def": "Un système qui permet de gérer les modifications effectuées sur un programme durant son développement.\n"
    },
    "pt": {
      "term": "sistema de controle de versão",
      "def": "Um sistema para gerenciar as mudanças feitas em um software durante o seu desenvolvimento.\n"
    }
  },
  {
    "slug": "vignette",
    "en": {
      "term": "vignette",
      "def": "A long-form guide used to provide details of a package beyond the README.md or function documentation.\n"
    }
  },
  {
    "slug": "vim",
  ...
  },
  {
    ...
    "en": {
      "term": "whitespace",
      "def": "The space, newline, carriage return, and horizontal and vertical tab characters that take up space but don't create a visible mark.  The name comes from their appearance on a printed page in the era of typewriters.\n"
    }
  },
  {
    "slug": "wildcard",
  ...
  },
  {
    ...
    "en": {
      "term": "XML",
      "def": "A set of rules for defining HTML-like tags and using them to format documents (typically data). XML achieved license plate popularity in the early 2000s, but its complexity led many programmers to adopt [JSON](#json) instead.\n"
    },
    "es": {
      "term": "XML",
      "def": "Un conjunto de reglas para definir etiquetas similares a HTML y usarlas para darle formato a documentos (normalmente datos). XML alcanzó popularidad a principios de la década de 2000, pero su complejidad llevó a muchos programadores a adoptar [JSON](#json) en su lugar.\n"
    }
  },
  {
    "slug": "yaml",
    "en": {
      "term": "YAML",
      "def": "Short for \"YAML Ain't Markup Language\", a way to represent nested data using indentation rather than the parentheses and commas of [JSON](#json). YAML is often used in configuration files and to define parameters for various flavors of [Markdown](#markdown) documents.\n"
    }
  }
]